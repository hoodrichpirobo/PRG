...
public class TextComparing {
    ...
    public static void main(String[] args) {  
        ...
        try {
            ...
            SetString cS1 = SetString.setReading(s1);// TO COMPLETE
            SetString cS2 = SetString.setReading(s2);// TO COMPLETE
            ...
            switch(option) {
                case 1:
                    SetString intersection = cS1.intersection(cS2);// TO COMPLETE
                    System.out.println(intersection);
                    break;
                case 2:
                    SetString union = cS1.union(cS2);// TO COMPLETE
